...
export function Features8() {
    return (
        <section className="bg-gray-50 py-16 md:py-32 dark:bg-transparent min-h-screen">
            <div className="mx-auto max-w-3xl lg:max-w-7xl px-6">
                <div className="relative">
                    <h1 className='text-center font-semibold text-4xl  text-black -mt-10 mb-13'>بایو ویو پیشرو در ارائه خدمات سلامت</h1>
                                        <h1 className='text-center font-ligh text-md  text-gray-700 -mt-10 mb-8'>بایو ویو پیشرو در ارائه خدمات سلامت</h1>

                    <div className='grid grid-cols-8'>
                    
                    <div className='col-span-8 lg:col-span-6 z-1 relative'>

                           <div className="relative z-10 grid grid-cols-6 gap-3">
                        <Card className="relative col-span-full flex overflow-hidden lg:col-span-2 shadow-none rounded-2xl">
                            <CardContent className="relative m-auto size-fit pt-6">
                                ...
                                <h2 className="mt-6 text-center text-3xl font-semibold">مورد اعتماد</h2>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 shadow-none rounded-2xl">
                                                        <Image src="/pat.png" width={1000} height={1000} alt='src' className='absolute -bottom-40 -left-50 opacity-70 z-1 animation-duration-60000 animate-spin'/>
                            ...
                            <CardContent className="pt-6">
                                ...
                                <div className="relative z-10 mt-6 space-y-2 text-center">
                                    <h2 className="group-hover:text-secondary-950 text-lg font-semibold transition dark:text-white">گزارش شخصی سازی شده</h2>
                                    <p className=" text-sm text-center text-gray-600">ریپورت ها و گزارشات درمانی کاملا شخصی سازی شده با توجه به نتایج ازمون و اطلاعات دموگرافیک بیماران</p>
                                </div>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 shadow-none rounded-2xl">
                            <CardContent className="pt-6">
                                <div className="pt-6 lg:px-6">
                                    <svg className="dark:text-muted-foreground w-full" viewBox="0 0 386 123" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        />
                                        <path
                                            className="text-blue-600 dark:text-primary-500"
                                ...
                                <div className="relative z-10 mt-14 space-y-2 text-center">
                                    <h2 className="text-lg font-semibold transition">بررسی روند پاسخ به درمان</h2>
                                    <p className="text-sm text-center text-gray-600">تجزیه و تحلیل روند پاسخ به درمان و سیر تکاملی علائم بالینی بیمار</p>
                                </div>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden lg:col-span-3 shadow-none rounded-2xl" dir='rtl'>
                            <CardContent className="grid pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        <h2 className="group-hover:text-secondary-950 text-lg font-bold text-zinc-800 transition dark:text-white">جمع آوری ایمن</h2>
                                        <p className="text-foreground">رمزگذاری چند مرحله ای داده های سلامتی شما برای حفظ دوچندان امنیت دیتا</p>
                                    </div>
                                </div>
                                <div className="rounded-tl-(--radius) relative -mb-6 -mr-6 mt-6 h-fit border-l border-t p-6 py-6 sm:ml-6">
                                    ...
                                    <svg className="w-full sm:w-[150%]" viewBox="0 0 366 231" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        />
                                        <path
                                            className="text-[#1d8eff] dark:text-primary-500"
                        ...
                        <Card className="relative col-span-full overflow-hidden lg:col-span-3 shadow-none rounded-2xl">
                            <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        <h2 className="text-lg font-bold text-center transition">مورد تائید برترین ها</h2>
                                        <p className="text-foreground text-center">حاذق ترین پزشکان در جمع کاربران و توصیه کنندگان بایو ویو</p>
                                    </div>
                                </div>
                                <div className="before:bg-(--color-border) relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px sm:-my-6 sm:-mr-6">
                                    <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">دکتر فرهنگ</span>
                                        ...
                                        <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                                            ...
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">دکتر عبدالهی</span>
                                        </div>
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">دکتر بابازاده</span>
                                            <div className="ring-background size-7 ring-4">
                        ...
                        <div className='col-span-8 lg:col-span-2 relative'>
                            {/* <Image src="/pat.png" width={1000} height={1000} alt='src' className='absolute -bottom-20 -left-20 z-1 animation-duration-30000 opacity-15 animate-spin'/> */}
                               <div className=' h-140 ml-3  rounded-2xl z-2 relative'>
        <Image className='md:mt-10 mt-3' src="/lp.svg" width={1000} height={1000} alt='djfodjf' />
                               </div>
